...
void loop() {
  for (int subtract = 0; subtract <= 1; subtract++) {
    for (int A7_Counter = 0; A7_Counter <= 1; A7_Counter++) {
      for (int A6_Counter = 0; A6_Counter <= 1; A6_Counter++) {
              ...
              for (int A2_Counter = 0; A2_Counter <= 1; A2_Counter++) {
                for (int A1_Counter = 0; A1_Counter <= 1; A1_Counter++) {
                  for (int A0_Counter = 0; A0_Counter <= 1; A0_Counter++) {
                    for (int B7_Counter = 0; B7_Counter <= 1; B7_Counter++) {
                      for (int B6_Counter = 0; B6_Counter <= 1; B6_Counter++) {
