...
TEJ4M
Final Project
8-Bit Full Adder and Subtractor with scenarios (Subtration)
*/
...
void loop() {
  for (int scenario = 8; scenario <= 15; scenario++) {
    ...
    if (scenario == 8) {
      // Scenario 09:
      // Positive number - Positive number, with positive output
      // 102 - 57 = 45

      Serial.print("Scenario 09:\n");
      Serial.print("Positive number - Positive number, with positive output\n");
      Serial.print("102 - 57 = 45");
    ...
    if (scenario == 9) {
      // Scenario 10:
      // Positive number - Positive number, with negative output
      // 39 - 77 = -38

      Serial.print("Scenario 10:\n");
      Serial.print("Positive number - Positive number, with negative output\n");
      Serial.print("39 - 77 = -38");
    ...
    if (scenario == 10) {
      ...
      Serial.print("Scenario 11:\n");
      Serial.print("Negative number - Positive number\n");
      Serial.print("(-68) - 13 = -81");
    ...
    if (scenario == 11) {
      // Scenario 12:
      // Negative number - Positive number, with underflow
      // (-112) - 49 = -161

      Serial.print("Scenario 12:\n");
      Serial.print("Negative number - Positive number, with underflow\n");
      Serial.print("(-112) - 49 = -161");
    ...
    if (scenario == 12) {
      ...
      Serial.print("Scenario 13:\n");
      Serial.print("Positive number - Negative number\n");
      Serial.print("81 - (-24) = 105");
    ...
    if (scenario == 13) {
      // Scenario 14:
      // Positive number - Negative number, with overflow
      // 67 - (-78) = 145

      Serial.print("Scenario 14:\n");
      Serial.print("Positive number - Negative number, with overflow\n");
      Serial.print("67 - (-78) = 145");
    ...
    if (scenario == 14) {
      // Scenario 15:
      // Negative number - Negative number, with positive output 
      // (-42) - (-67) = 25

      Serial.print("Scenario 15:\n");
      Serial.print("Negative number - Negative number, with positive output \n");
      Serial.print("(-42) - (-67) = 25");
    ...
    if (scenario == 15) {
      // Scenario 16:
      // Negative number - Negative number, with negative output 
      // (-87) - (-14) = -73

      Serial.print("Scenario 16:\n");
      Serial.print("Negative number - Negative number, with negative output \n");
      Serial.print("(-87) - (-14) = -73");
